...
checks={
 ...
 'module loaded':'js/v8-offline-continuity.js?v=8.2.8' in index,
 'app shell cache':"APP_CACHE = 'nv-app-shell-v828'" in sw and 'APP_SHELL' in sw,
...
print(f"Continuidad segura V8.2.8: {len(checks)-len(failed)}/{len(checks)} controles OK")
if failed:
