...
checks={
 ...
 'core loaded':'js/v8-financial-core.js?v=8.2.8' in index,
 'module loaded':'js/v8-financial-accounts.js?v=8.2.8' in index,
...
print(f'Interfaz financiera V8.2.8: {len(checks)}/{len(checks)} controles OK')
