const CACHE_NAME = 'good-king-v090-shell';
const CACHE_PREFIX = 'good-king-';
const LOCAL_SHELL = [
  './', './index.html', './styles.css?v=0.9.0', './config.js?v=0.9.0', './app.js?v=0.9.0',
  './v06.js?v=0.9.0', './v07.js?v=0.9.0', './v08.js?v=0.9.0', './v09.js?v=0.9.0', './manifest.webmanifest?v=0.9.0', './version.json',
...
self.addEventListener('fetch', event => {
  ...
  if(/\/(version\.json|config\.js|app\.js|v06\.js|v07\.js|v08\.js|v09\.js|styles\.css|manifest\.webmanifest)$/.test(url.pathname)) return event.respondWith(networkFirst(event.request,null));
