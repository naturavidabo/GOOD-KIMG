// NATURA VIDA V8.2.8 — asistente operativo, contraste accesible y saneamiento funcional.
const VERSION = 'natura-vida-v8-2-8-asistente-operativo-contraste-saneamiento-funcional';
const APP_CACHE = 'nv-app-shell-v828';
const IMAGE_CACHE = 'nv-images-v3';
const RUNTIME_CACHE = 'nv-runtime-v828';
